...
Copy-Item "ReSharper.FSharp\src\FSharp.TypeProviders.Protocol\bin\Release\net461\JetBrains.ReSharper.Plugins.FSharp.TypeProviders.Protocol.dll" -Destination "ReSharper.FSharp\src\FSharp.TypeProviders.Protocol\bin\Debug\net461\"
Copy-Item "ReSharper.FSharp\src\FSharp.TypeProviders.Host\bin\Release\net461\JetBrains.ReSharper.Plugins.FSharp.TypeProviders.Host.exe" -Destination "ReSharper.FSharp\src\FSharp.TypeProviders.Host\bin\Debug\net461\"
